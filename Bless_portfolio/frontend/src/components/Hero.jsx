...
function Hero() {
    ...
    return (
        <section style={{
            ...
            gap: '2rem',
            padding: isMobile ? '2rem 1.25rem' : '3.5rem 2rem 2.5rem',
        }}>
            ...
            <div style={{ maxWidth: '500px', width: '100%' }}>
                ...
                {/* Name */}
                <h1 style={{
                    fontSize: isMobile ? 'clamp(2.5rem, 12vw, 3.5rem)' : 'clamp(3rem, 8vw, 5.5rem)',
                ...
                <p style={{
                    ...
                    that actually ship. From Eldoret, Kenya.
                </p>
            ...
            {/* Terminal card — side by side on desktop, full width below on mobile */}
            <div style={{
