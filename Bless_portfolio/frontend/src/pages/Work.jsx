...
const projectGroups = [
  ...
  },
  {
    ...
    projects: [
      ...
      {
        name: 'Reduzer Django API',
        period: '2023 — 2024',
        desc: 'Full RESTful backend for Reduzer Technologies. Includes JWT authentication, PostgreSQL integration, BigQuery schemas and a fully containerized deployment on Digital Ocean.',
        stack: ['Python', 'Django', 'PostgreSQL', 'JWT', 'BigQuery'],
        github: null,
        playstore: null,
        status: 'private',
      },
    ...
    projects: [
      {
        ...
        period: '2023 — 2024',
        desc: 'Containerized the entire Reduzer Django backend with Docker and Docker Compose. Multi-service setup with PostgreSQL, Django, and Nginx — deployed to Digital Ocean droplets.',
      ...
      },
      {
        ...
        period: '2023 — 2024',
        desc: 'Built and maintained CI/CD pipelines using Travis CI for the Reduzer platform. Automated testing, building and deployment — achieving significantly faster release cycles.',
        stack: ['Travis CI', 'CI/CD', 'Docker', 'Digital Ocean'],
        github: null,
        playstore: null,
        status: 'private',
      },
