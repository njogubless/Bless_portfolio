...
excerpt: >-
  Eleven blocking issues found in a money-moving codebase — floats used for
  currency, unverified payment webhooks, plaintext tokens — and the eleven
  short, honest write-ups documenting how each one got fixed.
category: backend
date: 2026-05-05
